...
export default function TeamMember({href, name, role, img, buttonText}: TeamMemberProps) {
    return (
        <figure
            className="group border border-white/10 rounded-4xl p-4 md:p-8 flex flex-col justify-center duration-300 ease-in-out
            items-center w-72 md:w-96 h-96 md:h-[32rem] hover:border-primary-400 bg-white/5 overflow-hidden transition-colors relative"
        >
            <Image
