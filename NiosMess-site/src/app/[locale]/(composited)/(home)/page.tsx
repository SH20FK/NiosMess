...
export default function Home() {
    ...
    return (
        <>
            <IconCanvas probability={0.02} paths={checkedIcons} color="#F97316" height={2000}/>

            <section className="w-full flex justify-center items-center flex-col gap-6 mt-36 md:mt-48 mb-20 px-6" id="top">
                <p className="text-sm md:text-base uppercase tracking-[0.3em] text-primary-200">
                    {t("eyebrow")}
                </p>
                <h1 className="text-primary-500 font-bold font-display text-5xl md:text-6xl lg:text-7xl text-center">
                    {t("title")}
                </h1>
                <p className="text-lg md:text-2xl text-neutral-300 w-full md:w-[34rem] text-center">
                    {t("description")}
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                    <Link href="/#download">
                        <Button className="bg-primary-500 text-white hover:text-white hover:bg-primary-400">
                            {t('more.download')}
                        </Button>
                    </Link>
                    <Link href={t("webHref")}>
                        <Button className="bg-white/10 text-white hover:bg-white/20 hover:text-white">
                            {t('openWeb')}
                        </Button>
                    </Link>
                </div>
            ...
            <section
                className="bg-[#15101b] text-white justify-between flex lg:px-24 lg:py-36 lg:gap-4 mb-16 flex-col w-full-no-offset
                lg:flex-row rounded-4xl lg:rounded-6xl lg:h-[28rem] mt-32 sm:p-12 sm:pt-16 gap-12 p-6 pt-12 mx-offset md:o-16
                            ...
                            content: (
                                <div className="flex flex-col items-center gap-8 justify-center w-full h-full">
                                    <Link
                                        href="/#more"
                                        role="button"
                                        className="w-32 h-32 aspect-square hover:bg-primary-400 flex-col hover:text-white
                                        rounded-full bg-primary-500 text-white flex justify-center items-center transition-colors
                                        active:bg-primary-200 active:text-white duration-300 ease-in-out"
                                    >
                                        <SquareArrowDown size={60} iconStyle="Bold" />
                                    </Link>
                                    <p className="text-neutral-300 text-xl font-medium">{t("features.button")}</p>
                                </div>
                            )
                        },
                    ]}
                    className="lg:w-[32rem] h-fit md:h-[36rem] lg:-translate-y-96 rounded-3xl bg-[#221829] text-white border border-white/10"
                    leftOffset={24}
                />
            </section>
            ...
            <Anchor id="more" />
            <section
                className="flex justify-center items-center flex-col gap-24 mb-16 border py-12 px-4 md:px-12 lg:p-20
                border-white/10 rounded-4xl md:rounded-6xl bg-[#141019] md:o-16 o-4 mx-offset w-full-no-offset"
            >
                    ...
                    return (
                        ...
                        >
                            ...
                            <figcaption
                                ...
                                <p className="text-neutral-200 text-lg md:text-xl xl:text-2xl mt-4 md:mt-6">
                ...
                <figure className="flex flex-col gap-4 lg:gap-6 items-center">
                    ...
                    <p className="text-lg md:text-xl xl:text-2xl text-neutral-300 w-full max-w-lg text-center">
                        {t("more.description")}
                    </p>
                    <Link
                        href="/#download"
                    >
                        <Button className="bg-primary-500 text-white hover:bg-primary-400 hover:text-white">
                            {t('more.download')}
                        </Button>
                    </Link>
                </figure>
            ...
            >
                <Marquee rotation={8} className="text-white/10" scrollBoost={0.25}>
                    {splashes.join(" ")}
                </Marquee>
                <div className="h-4 md:h-12" />
                <Marquee rotation={8} baseVelocity={-1} className="text-white text-outline-neutral-700" scrollBoost={0.25}>
                    {splashes.join(" ")}
                </Marquee>
            </div>
