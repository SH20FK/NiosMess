    ...
    return (
        <MenuContext.Provider value={{
            ...
            <nav
                ...
                inset-0 w-screen md:w-auto h-screen md:h-auto flex-col md:flex-row justify-center bg-[#0d0b12] text-center z-10
            ...
            >
             ...
             <div className={`md:hidden ${open ? 'translate-y-full' : '-translate-y-full'} bg-[#201221] w-screen 
