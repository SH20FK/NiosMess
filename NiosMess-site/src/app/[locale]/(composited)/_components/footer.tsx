...
export default function Footer() {
    ...
    return (
        <footer className="flex flex-col gap-16 mt-16 px-8 md:px-16 pt-8 pb-16 border-t border-white/10 bg-[#0d0b12]">
            <div className="flex flex-col lg:flex-row w-full justify-between items-center gap-8">
                <div className="flex flex-col gap-4 items-center lg:items-start mb-12 md:mb-0">
                    ...
                    <p className="text-lg text-neutral-300 w-full max-w-sm text-center lg:text-left">{t("description")}</p>
                </div>
                ...
                <Link
                    ...
                    className="group w-32 h-32 font-bold font-display aspect-square text-4xl overflow-hidden hover:bg-primary-500 flex-col
                        hover:text-white rounded-full bg-white/10 text-primary-200 flex justify-center items-center transition-colors
                        active:bg-primary-400 active:text-white duration-300 ease-in-out min-w-max min-h-max"
                >
            ...
            <div className="flex flex-col lg:flex-row w-full justify-center items-center gap-2 lg:gap-8 text-neutral-400">
                <div className="hover:font-semibold transition-all flex gap-1">
                    {t('credits.design') + ' '}
                    <Link href="https://t.me" className="text-primary-400" underline>
                        NiosMess Studio
                    </Link>
                </div>
                <div className="hover:font-semibold transition-all flex gap-1">
                    {t('credits.dev') + ' '}
                    <Link href="https://github.com" className="text-primary-400" underline>
                        NiosMess Team
                    </Link>
                </div>
            </div>
