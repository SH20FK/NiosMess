...
export default function Header() {
    ...
    return (
        <header
            className="flex justify-between items-center mb-12 font-display font-bold text-xl md:text-2xl sticky top-0 py-4 md:py-6
            px-6 md:px-12 z-40 backdrop-blur-xl bg-[#0d0b12]/70 border-b border-white/10"
        >
            ...
            <HeaderMenu>
                ...
                <HeaderLink href="https://github.com" mobile>
                    {t('source')}
                </HeaderLink>
                <HeaderLink href="https://t.me" mobile>
                    {t('chats')}
                </HeaderLink>
            </HeaderMenu>
        </header>
