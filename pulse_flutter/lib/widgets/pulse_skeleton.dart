...
class _PulseSkeletonState extends State<PulseSkeleton>
  ...
  Widget build(BuildContext context) {
    ...
    final double effectiveT = widget.t ?? _controller.value;
    ...
    return ShaderMask(
      ...
      shaderCallback: (Rect bounds) {
        return LinearGradient(
          ...
          transform: _SlidingGradientTransform(slidePercent: effectiveT),
        ).createShader(bounds);
      },
      child: Container(
        width: widget.width,
            ...
            return Align(
              ...
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    PulseSkeleton(t: _controller.value, width: bubbleWidth, height: 14, borderRadius: 6),
                    const SizedBox(height: 8),
                    PulseSkeleton(
                      t: _controller.value,
