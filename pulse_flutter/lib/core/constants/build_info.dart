...
class BuildInfo {
  ...
  static const String version = '3.87.0';

  /// Build number (e.g. "147").
  static const String buildNumber = '185';

  /// Version with 'v' prefix (e.g. "v3.63.1").
  static const String versionWithPrefix = 'v3.87.0';

  /// Full version with build number (e.g. "v3.63.1+147").
  static const String fullVersion = 'v3.87.0+185';
