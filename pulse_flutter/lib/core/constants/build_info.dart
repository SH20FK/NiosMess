...
class BuildInfo {
  ...
  static const String version = '3.88.1';

  /// Build number (e.g. "147").
  static const String buildNumber = '187';

  /// Version with 'v' prefix (e.g. "v3.63.1").
  static const String versionWithPrefix = 'v3.88.1';

  /// Full version with build number (e.g. "v3.63.1+147").
  static const String fullVersion = 'v3.88.1+187';
