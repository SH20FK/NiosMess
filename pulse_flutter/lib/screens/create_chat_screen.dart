...
class _CreateChatScreenState extends ConsumerState<CreateChatScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // If group and members were selected, invite them
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            TextButton(
              ...
              child: Text(
                _step == 0 ? context.l10n.groupContinue : context.l10n.groupCreate,
                style: TextStyle(
          ...
          child: Column(
            children: <Widget>[
              Padding(
                ...
                child: _buildStepIndicator(context, scheme, textTheme),
              ),
              Expanded(
              ...
              _buildBottomBar(context, scheme, textTheme),
            ],
          ),
        ),
      ),
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            Text(
              _chatType == 'channel' ? 'Канал' : 'Группа',
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Поиск контактов по имени или @username...',
  ...
  Widget _buildDirectContactsList(
    ...
    if (contacts.isEmpty) {
      return Container(
        ...
        child: Text(
          'У вас пока нет активных диалогов для быстрого добавления.',
      ...
      children: <Widget>[
        ...
        _privacyCard(
          ...
          subtitle: _chatType == 'channel'
              ? 'Канал доступен только по защищенной ссылке-приглашению'
        ...
        _privacyCard(
          ...
          subtitle: _chatType == 'channel'
              ? 'Канал открыт для всех в поиске и имеет публичную ссылку'
        ...
        if (_isPublic) ...<Widget>[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              helperText: 'От 3 до 32 символов (буквы, цифры, _)',
              filled: true,
              fillColor: scheme.surfaceContainerLow,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(20),
