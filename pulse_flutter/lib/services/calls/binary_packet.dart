...
const int kPacketTypePeerLeave = 0x07;
...
///
/// Wire format (matches calls.html:1064-1068): `[0x01][iv 12B][encrypted data]`.
/// The SFU server injects the sender client ID at bytes 1..5 when relaying.
